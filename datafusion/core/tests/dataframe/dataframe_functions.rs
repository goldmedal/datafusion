...
async fn test_fn_map() -> Result<()> {
    ...
    let expected = [
        "+---------------------------------------------------------------------------------------+",
        "| map(make_array(Int32(10),Int32(20),Int32(30)),make_array(Int32(1),Int32(2),Int32(3))) |",
        "+---------------------------------------------------------------------------------------+",
        "| {10: 1, 20: 2, 30: 3}                                                                 |",
        "| {10: 1, 20: 2, 30: 3}                                                                 |",
        "| {10: 1, 20: 2, 30: 3}                                                                 |",
    ...
    let expr = map_from_array(
        vec![lit(10), lit(20), lit(30), lit(1), lit(2), lit(3)],
    );
    let expected = [
        "+-------------------------------------------------------------------+",
        "| map_one(Int32(10),Int32(20),Int32(30),Int32(1),Int32(2),Int32(3)) |",
        "+-------------------------------------------------------------------+",
        "| {10: 1, 20: 2, 30: 3}                                             |",
        "| {10: 1, 20: 2, 30: 3}                                             |",
        "| {10: 1, 20: 2, 30: 3}                                             |",
